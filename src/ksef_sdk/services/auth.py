...
from ksef_sdk.core.crypto import encrypt_token
...
from ksef_sdk.endpoints.auth import (
    AuthStatusEndpoint,
    ChallengeEndpoint,
    RedeemTokenEndpoint,
...
class AuthService:
    ...
    def authenticate_xades(
        ...
        *,
        ...
        from ksef_sdk.core.xades import build_auth_token_request_xml, sign_xades
